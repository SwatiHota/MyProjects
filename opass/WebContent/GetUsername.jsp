...
function check()
{
if (document.getElementById('uid','longtermpassword').value=="")
{
alert("Enter UserID...");
...
<div class="main-agileits">
	<h4 class="sub-head">LOGIN</h4>
		<div class="sub-main">	
			<form id="form1" name="form1" method="post" action="Authentication"  onsubmit="return check();">
				<input placeholder="UID" name="uid" class="uid" type="text" required=""/>
					<span class="icon1"><i class="fa fa-user" aria-hidden="true"></i></span>
					<input placeholder="Password" name="longtermpassword" class="longtermpassword" type="password" required=""/>
