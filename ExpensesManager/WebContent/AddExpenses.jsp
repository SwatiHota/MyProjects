...
function display()
{
 alert(" YOUR EXPENSES ADDED SUCCESSFULLY");
}
</script>
</head>
			...
			<section id="content" style="padding: 0 0 70px 250px; width: 900px;" >
				<div class="wrapper" style="padding: 0;">
					...
					<article class="col2" style="width: 600px;">
						<form id="form_1"  action="addexpenses.do" method="post" style="width: 600px; height: auto;">
							<div class="pad1">
								<h2>Add Expenses</h2>
...
$(t).val($(t).data('oldValue'));
								...
								<div class="row_select">
									<div class="cols"> Description:<br> 
											<textarea name="descr" rows="6" cols="30" style="font-size: 150%;"></textarea><br>
									</div>
